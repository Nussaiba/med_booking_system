...
class AppColor {
  ...
  static Color praimaryColor = Colors.blue;

  static Color praimary2Color = Color(0xff769FCD);
  static Color praimary3Color = Color(0xffB9D7EA);
  static Color praimary4Color = Color(0xffD6E6F2);
  static Color white5Color = Color(0xffF7FBFC);
