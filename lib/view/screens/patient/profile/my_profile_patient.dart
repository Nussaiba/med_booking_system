      ...
      child: Column(
        children: [
          _buildInfoSection(
            ...
            icon: Icons.contact_mail,
            children: [
              _buildInfoItem(Icons.email, 'Email', p.email),
              _buildInfoItem(Icons.phone, 'Phone', p.phone),
              _buildInfoItem(Icons.location_on, 'Address', p.address),
            ],
          ),
          SizedBox(height: 16),
          _buildInfoSection(
            ...
            icon: Icons.person_outline,
            children: [
              _buildInfoItem(Icons.person, 'Gender', p.gender),
              _buildInfoItem(Icons.cake, 'Date of Birth',
                  DateFormat('MMMM d, y').format(p.birthDate)),
